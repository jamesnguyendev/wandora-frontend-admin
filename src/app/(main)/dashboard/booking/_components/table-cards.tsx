...
import { ResponseBooking } from "@/types/booking";

import { recentLeadsColumns } from "./columns.crm";

export function TableCards({ data }: { data: ResponseBooking }) {
      ...
      <Card>
        ...
        <CardContent className="flex size-full flex-col gap-4">
          ...
          <div className="flex flex-col justify-between gap-1.5 md:flex-row">
            <div className="px-4 text-sm font-medium">Total Bookings: {table.getRowCount()}</div>
